...
<head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="<?= base_url ('css/mobile-css/style.css')?>">
    ...
    border-color: rgb(236, 182, 19) !important;
     ...
     .keypad-btn {
      ...
      @media (max-width: 768px) {
        ...
        /* Mobile improvements for check-in/check-out section */
...
<body>
     <div
      ...
      <div class="text-center" style="max-width: 450px; width: 100%">
        <!-- Header -->
        <img src="<?= base_url('images/logo.png')?>" alt="ARMANI'S GYM" class="w-40 h-40 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-60 lg:h-60 transform justfify-center mx-auto">
   ...
   <div id="reset-section" style="display: none">
    <button class="reset-btn" onclick="resetCode()">Try Again</button>
       ...
       <!-- CAPTCHA Section -->
       <div id="captcha-container" class="captcha-container mb-4" style="background: #1a1a1a; padding: 15px; border-radius: 10px; text-align: center; display: none;">
        ...
        <div class="d-flex justify-content-center align-items-center gap-3">
          ...
          <button type="button" id="verify-captcha" class="btn" style="background: #ffc107; color: #000; border: none; border-radius: 5px; padding: 5px 10px; font-size: 0.9rem;">
    ...
    <div id="app-section" class="d-none">
            ...
            <div class="min-h-screen bg-background">
                <!-- Header -->
                <header class="sticky top-0 z-50 bg-black/60 backdrop-blur-md border-b border-secondary/50 p-1">
                    <div class="max-w-4xl mx-auto flex items-center justify-between">
                        <div class="flex items-center gap-1">
                            <div class="relative">
                                <div class="absolute inset-0 rounded-full blur-lg opacity-30"></div>
                                <div class="relative p-3 rounded-full">
                                  <img src="<?= base_url('images/logo.png')?>" alt="ARMANI'S GYM" class="w-16 h-16">
                                </div>
                            </div>
                            <div>
                        ...
                        <button id="lp-settings-button" title="Settings" class="text-foreground/60 hover:text-foreground transition-colors">
                            <i data-lucide="settings" class="w-6 h-6 mr-6"></i>
                        </button>
                    </div>
                </header>
                <!-- Main Content -->
                <main class="max-w-4xl mx-auto p-4 py-8">
                    ...
                    <div class="bg-gradient-to-b from-secondary/40 to-secondary/60 rounded-3xl shadow-2xl border border-secondary/50 overflow-hidden mb-8">
                        ...
                        <div class="relative px-3 pb-3">
                            ...
                            <div class="absolute -top-16 left-6">
                                <div class="relative">
                                    <div class="w-40 h-40 rounded-full border-4 border-secondary bg-gradient-to-br from-secondary/60 to-secondary overflow-hidden">
                            ...
                            <div class="pt-28">
                                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                                    <div class="flex-1">
                                        <h2 class="text-3xl font-bold text-foreground mb-2">Joseph Mendoza</h2>
                        ...
                        <div class="bg-gradient-to-b from-secondary/40 to-secondary/60 rounded-2xl border border-secondary/50 p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-3 border-b border-secondary/30">
                                    ...
                                    <span class="text-foreground font-medium">Joseph Mendoza</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-secondary/30">
                                    <span class="text-foreground/60">Email</span>
                                    <span class="text-foreground font-medium">joseph.mendoza@email.com</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-secondary/30">
                                    <span class="text-foreground/60">Phone</span>
                                    <span class="text-foreground font-medium">+639281129423</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-secondary/30">
                                ...
                                <div class="flex justify-between items-center py-3 border-b border-secondary/30">
                                    ...
                                    <span class="text-foreground font-medium">Sarah Mendoza</span>
                                </div>
                                <div class="flex justify-between items-center py-3">
                                    <span class="text-foreground/60">Address</span>
                                    <span class="text-foreground font-medium text-right">1234 BBB Marulas, <br>Valenzuela City</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-b from-secondary/40 to-secondary/60 rounded-2xl border border-secondary/50 p-6">
                        ...
                        <div class="overflow-x-auto">
                            <table id="fitness-logs-table" class="min-w-full table-auto border-collapse text-sm">
                                <thead>
...
<div id="lp-settings-screen" class="fixed inset-0 hidden z-50">
  <div class="min-h-screen bg-black/80 backdrop-blur-sm p-4 overflow-auto">
   <div class="w-full sm:max-w-[50%] mx-auto">

      
      <!-- Content Grid -->
      <div class="flex flex-col gap-4 justify-center">
        
        <!-- Header (now same width as card) -->
        <div class="bg-secondary/60 border border-secondary/40 rounded-2xl p-4 flex items-center justify-between">
        ...
        <div class="bg-secondary/40 border border-secondary/40 rounded-2xl p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input id="lp-new-pin" type="password" maxlength="4" class="form-input" placeholder="Enter 4-digit PIN" inputmode="numeric" />
            </div>
            <div>
              <label class="block text-foreground/60 text-sm font-medium mb-2" for="lp-confirm-pin">Confirm PIN</label>
              <input id="lp-confirm-pin" type="password" maxlength="4" class="form-input" placeholder="Re-enter PIN" inputmode="numeric" />
            </div>
          </div>
          <div class="flex gap-3 pt-4">
